...
int mode = 1;
std::vector<unsigned int> textures = std::vector<unsigned int>(6, 0);
std::vector<std::string> names = { "B", "F", "L", "R", "D", "U" };
...
int main(int argc, char ** argv)
{
    ...
    std::vector<PointLight> pointLights = {
        PointLight(glm::vec3(5.0f, 5.0f, 3.0f), glm::vec3(1.0f)),
    };
    ...
    for (int i = 0; i < textures.size(); i++) {
        textures[i] = loadTexture("resource\\texture-" + names[i] + ".png");
    }
    ...
    std::cout << "Press 'WASDRFQE' to explore:" << std::endl
        ...
        << std::endl
        << "Press 'Z' to change the texture mode." << std::endl;
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        setMat4(shader, "model", glm::mat4(1));
        ...
        std::string mode_str = mode == 1 ? "MIPMAP" : (mode == 2 ? "NEAREST" : "LINEAR");
        textr.RenderText(textShader, "Mode :  " + mode_str, 20.0f, 20.0f, 0.8f, text_green);
        glDisable(GL_BLEND);
